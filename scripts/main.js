...
function writeHikes() {
    ...
    hikesRef.add({
        code: "AM01",
        name: "Garibaldi Lake", //replace with your own city?
        city: "Vancouver",
        province: "BC",
        level: "hard",
        details: "Close to town, and relaxing",
        length: 20,      //number value
        hike_time: 10,     //number value
    ...
    hikesRef.add({
        code: "NV01",
        name: "Surrey Lake", //replace with your own city?
        city: "Surrey",
        province: "BC",
        level: "easy",
        details:  "nice views, easy",
        length: 4,        //number value
        hike_time: 30,     //number value
